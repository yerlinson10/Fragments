...
async function discoverStories() {
  ...
  for (const id of knownStories) {
    try {
      ...
      console.log(`Historia ${id} no encontrada`);
    }
  }
...
document.getElementById('confirmDelete').addEventListener('click', async () => {
  ...
  try {
    ...
    console.log('Historia eliminada del cliente:', storyToDelete);
    alert('Nota: Para eliminar permanentemente, debes eliminar la carpeta manualmente de stories/');
  } catch (error) {
